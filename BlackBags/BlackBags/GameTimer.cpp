	...
	, m_TextFormat(nullptr)
{
	...
	m_DWriteFactory->CreateTextFormat(L"Consolas" //SM9: 나중에 이런 폰트 이름 따로 다 뺄 것. 콘솔라스 폰트가 없는 컴퓨터라면?
		, NULL
...
{
	GetSystemTime(&m_CurrentTime); //SM9: 사실 이 API는 부하가 좀 크다.. GetTickCount() 사용을 고려해봐라.
